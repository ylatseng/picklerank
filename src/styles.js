export function makeS(t) {
  ...
  return {
    ...
    iconBtn:    { background:"none", border:"none", fontSize:f(18), cursor:"pointer", padding:`${f(3)}px ${f(4)}px`, flexShrink:0 },
    ...
    gameRow:    { display:"flex", alignItems:"center", gap:f(4), marginBottom:f(8), flexWrap:"nowrap" },
    scoreInput: { background:t.bg, border:`1px solid ${t.border}`, borderRadius:f(10), color:t.text, fontSize:f(16), padding:`${f(8)}px ${f(4)}px`, width:f(64), flex:"0 0 auto", textAlign:"center", outline:"none", lineHeight:1.5, minWidth:0, boxSizing:"border-box" },
