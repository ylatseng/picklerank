export function makeS(t) {
  ...
  return {
    ...
    scoreInput: { background:t.bg, border:`1px solid ${t.border}`, borderRadius:f(10), color:t.text, fontSize:f(18), padding:`${f(10)}px`, width:f(72), textAlign:"center", outline:"none", lineHeight:1.5 },
    btnPrimary: { background:t.accent, border:"none", borderRadius:f(10), color:t.invert ? "#fff" : "#0d1a10", cursor:"pointer", fontSize:f(14), fontWeight:800, padding:`${f(14)}px ${f(20)}px`, whiteSpace:"nowrap", lineHeight:1.5 },
